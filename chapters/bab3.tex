...
6. & Redirect Whatsapp & Sistem mengalihkan pelanggan ke aplikasi WhatsApp dengan format pesan otomatis. & Sistem \\ \hline
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{diagram-alir-penelitian.png}
